...
export function Upload({fileName = null, legend, ...rest}: Props){
  return(
    <div>
      {legend && <legend className='uppercase text-xxs text-200 mb-2'>{legend}</legend>}

      <div
       className='w-full h-12 flex items-center rounded-lg border
      border-gray-300 text-sm text-gray-100 bg-transparent outline-none'>
        ...
        className='flex h-12 px-4 items-center bg-green-100
