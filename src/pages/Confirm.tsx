...
export function Confirm(){
  ...
  return(
    <div className='bg-gray-500 lg:w-[512px] rounded-xl flex flex-col items-center p-10 gap-6'>
      <h1 className='text-2xl font-bold text-center text-green-100 '>Solicatação enviada!</h1>
      <img src={okSvg} alt="Ícone de OK" className='w-28'/>
      <p className='text-sm text-gray-200 text-center'>
        Agora é apenas aguardar, sua solicitação sera análisada e embreve o setor 
        financeiro entrará em contato com voce
      </p>
